...
char_birthdays = {
    ...
    "南小鳥聲優 內田彩": "07-23",
    "小原鞠莉聲優 鈴木愛奈": "07-23",
    "日本一の富士の山 沼津が誇る海と川 太陽愛する彼女が一応 Aqoursのリーダー高海千歌": "08-01",
    "果皇 高坂穗乃果": "08-03",
    "菜寶 法元明菜": "08-05",
    "鬼塚夏美": "08-07",
    "優木雪菜": "08-08",
...
async def on_message(message):
    ...
    if clean_text == "Oh my god" or clean_text == "oh my god":
        await message.reply(f'内緒ね Chu! Chocolate')
